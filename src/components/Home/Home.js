...
import banner from './img/shape-png.png'
        ...
        <div className='' style={{}}>
            <div className='py-36 bg-gray-100 h-full grid grid-cols-1 md:grid-cols-2 items-center justify-items-center gap-4 md:justify-items-around content-center'>
                <div className='order-2 md:order-1'>
                    <div className='p-20'>
                        <h1 className='text-5xl font-mono font-bold'>Laptop analytics with <span className='text-orange-400'>pre-built</span> reports and guided setup</h1>
